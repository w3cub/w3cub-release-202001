...
(function() {
  var ESCAPE_HTML_MAP, ESCAPE_HTML_REGEXP, ESCAPE_REGEXP, HIGHLIGHT_DEFAULTS, buildFragment, isAndroid, isIE, isIOS, isMac, requestAnimFrame, smoothDistance, smoothDuration, smoothEnd, smoothScroll, smoothStart,
    slice = [].slice;
...
(function() {
  ...
  app.views.DocList = (function(superClass) {
    ...
    DocList.prototype.onClick = function(event) {
      var doc, slug;
      if (this.disabledTitle && $.hasChild(this.disabledTitle, event.target) && event.target.tagName !== 'A') {
        $.stopEvent(event);
        this.toggleDisabled();
